...
本仓库只发布线上招聘题目和第一题运行材料，不接收个人答案。请先阅读两份题面，再按招聘通知进入招聘方单独提供的 GitHub 私有作答仓库提交答案。不要在本公开仓库创建分支、Pull Request 或提交个人答案。
...
第一题和第二题都要求通过招聘方单独提供的 GitHub 私有作答仓库提交最终材料，并通过 Pull Request 提交最终版本。请保留主要工作过程的提交记录。每位候选人应使用独立私有仓库或仅本人和招聘方可见的私有空间，避免候选人之间互相看到答案。
