...
本仓库只发布线上招聘题目和第一题运行材料，不接收个人答案。请先阅读两份题面，再创建您自己的 GitHub 私有作答仓库提交答案。不要在本公开仓库创建分支、Pull Request 或提交个人答案。
...
第一题和第二题都请提交到您自己的 GitHub 私有作答仓库。请将仓库链接发给招聘方，并邀请 GitHub 账号 `dldldl888`，以便面试官查看；不要向本公开题库发起 Pull Request。请保留主要工作过程的提交记录。每位候选人应使用独立私有仓库，避免候选人之间互相看到答案。
